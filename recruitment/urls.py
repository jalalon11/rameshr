...
from recruitment.forms import RecruitmentCreationForm, StageCreationForm
...
urlpatterns = [
    ...
    path(
        ...
        kwargs={
            "model": Recruitment,
            "form_class": RecruitmentCreationForm,
            "template": "recruitment_form.html",
            "field_type": "character",
            "field_name_pre": "recruitment",
        },
    ),
    ...
    path(
        "api/open-recruitments",
        views.open_recruitments_api,
        name="open-recruitments-api",
    ),
    path(
        "application-form",
