...
def general_settings(request):
    ...
    if apps.is_installed("payroll"):
        ...
        # If no payroll settings exist yet, show Peso (₱) and prefix as the defaults
        if currency_instance is None:
            currency_form = PayrollSettingsForm(
                instance=None, initial={"currency_symbol": "₱", "position": "prefix"}
            )
        else:
